...
<body>
     ...
     <section class="banner-bottom-wthreelayouts py-lg-5 py-3">
          <div class="container">
               <h3 class="tittle-w3layouts text-center my-lg-4 my-4">FEEDBACK</h3>


               <div class="contact_grid_right">
                    <form action="vfeedback_code.php" enctype="multipart/form-data" method="post">
                         <div class="row contact_left_grid">
                              <div class="col-md-12 con-left">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <textarea cols="30" rows="5" class="form-control" type="text" name="msg" placeholder="" required=""></textarea>
                                   </div>
